...
MultiSelectComboBox::MultiSelectComboBox(QWidget *aParent) : QComboBox(aParent),
...
void MultiSelectComboBox::setSelected(int index, bool checked)
{
    int count = mListWidget->count();
    ...
    QWidget *widget = mListWidget->itemWidget(mListWidget->item(index + 1));
    QCheckBox *checkBox = static_cast<QCheckBox *>(widget);
    checkBox->setChecked(checked);
}

std::vector<int> MultiSelectComboBox::getSelectedIndexes()
{
